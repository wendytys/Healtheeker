...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://blossomthemes.com/theme-demo/?theme=blossom-feminine' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'blossom-feminine' ); ?>" target="_blank"><?php _e( 'View Demo', 'blossom-feminine' ); ?></a>
    </div><!-- .panel-aside -->
</div>
