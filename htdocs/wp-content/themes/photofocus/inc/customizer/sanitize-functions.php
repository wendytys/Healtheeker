<?php
/**
 * PhotoFocus Theme Options Sanitization Functions
 *
 * @package PhotoFocus
 */
 ...
 */
function photofocus_sanitize_select( $input, $setting ) {
 ...
 */
function photofocus_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function photofocus_sanitize_post( $input ) {
 ...
 */
function photofocus_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function photofocus_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if ( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function photofocus_sanitize_number_range( $number, $setting ) {
